...
public class GeneralPickupAdapter extends RecyclerView.Adapter<GeneralPickupAdapter.GeneralPickUpHolder> {

    private ArrayList<ParcelDm> parcelDms;
    private Context myContext;

    public GeneralPickupAdapter(ArrayList<ParcelDm> parcelDms, Context myContext) {
    ...
    @NonNull
    @Override
    public GeneralPickUpHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from((parent.getContext())).inflate(R.layout.pickup_details_show_layout,parent,false);

        return new GeneralPickUpHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final GeneralPickUpHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(myContext,ParcelDetailsActivity.class);
    ...
    public class GeneralPickUpHolder extends RecyclerView.ViewHolder{


        TextView name,Id,amount,complete;
        LinearLayout layout;

        public GeneralPickUpHolder(@NonNull View itemView) {
            super(itemView);
